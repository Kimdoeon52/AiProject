...
game_data.regions = {
  -- r0 북단
  { id = "jinyang",  name = "진양", q = 1, r = 0, pop = 45, commerce = 50, land = 55, loyal = 52, flood = 48, gold = 600,  grain = 1800 },
  { id = "bohai",    name = "발해", q = 2, r = 0, pop = 88, commerce = 62, land = 68, loyal = 58, flood = 55, gold = 850,  grain = 2600 },
  { id = "beiping",  name = "북평", q = 3, r = 0, pop = 22, commerce = 42, land = 48, loyal = 50, flood = 45, gold = 480,  grain = 1500 },
  -- r1 하북
  { id = "wuwei",    name = "무위", q = 0, r = 1, pop = 12, commerce = 32, land = 38, loyal = 48, flood = 40, gold = 350,  grain = 1100 },
  { id = "ye",       name = "업",   q = 1, r = 1, pop = 100, commerce = 78, land = 80, loyal = 60, flood = 58, gold = 1300, grain = 3600 },
  { id = "pingyuan", name = "평원", q = 2, r = 1, pop = 58, commerce = 52, land = 58, loyal = 55, flood = 50, gold = 620,  grain = 1900 },
  { id = "puyang",   name = "복양", q = 3, r = 1, pop = 55, commerce = 58, land = 60, loyal = 54, flood = 52, gold = 680,  grain = 2000 },
  { id = "xiapi",    name = "하비", q = 4, r = 1, pop = 60, commerce = 60, land = 62, loyal = 53, flood = 52, gold = 720,  grain = 2100 },
  -- r2 중원
  { id = "tianshui", name = "천수", q = -1, r = 2, pop = 16, commerce = 35, land = 42, loyal = 48, flood = 42, gold = 380,  grain = 1200 },
  { id = "changan",  name = "장안", q = 0, r = 2, pop = 95, commerce = 75, land = 78, loyal = 55, flood = 56, gold = 1200, grain = 3400 },
  { id = "hongnong", name = "홍농", q = 1, r = 2, pop = 32, commerce = 48, land = 52, loyal = 52, flood = 50, gold = 520,  grain = 1600 },
  { id = "luoyang",  name = "낙양", q = 2, r = 2, pop = 110, commerce = 85, land = 82, loyal = 58, flood = 60, gold = 1500, grain = 4000 },
  { id = "chenliu",  name = "진류", q = 3, r = 2, pop = 70, commerce = 66, land = 68, loyal = 55, flood = 54, gold = 900,  grain = 2700 },
  { id = "xuchang",  name = "허창", q = 4, r = 2, pop = 85, commerce = 72, land = 74, loyal = 60, flood = 56, gold = 1050, grain = 3100 },
  { id = "pengcheng",name = "팽성", q = 5, r = 2, pop = 52, commerce = 55, land = 58, loyal = 52, flood = 50, gold = 640,  grain = 1900 },
  -- r3 형북·예남·강동북
  { id = "hanzhong", name = "한중", q = -1, r = 3, pop = 38, commerce = 52, land = 62, loyal = 56, flood = 55, gold = 650,  grain = 2300 },
  { id = "xinye",    name = "신야", q = 0, r = 3, pop = 26, commerce = 40, land = 50, loyal = 52, flood = 48, gold = 420,  grain = 1400 },
  { id = "xiangyang",name = "양양", q = 1, r = 3, pop = 74, commerce = 70, land = 72, loyal = 57, flood = 56, gold = 980,  grain = 2900 },
  { id = "runan",    name = "여남", q = 2, r = 3, pop = 92, commerce = 68, land = 70, loyal = 54, flood = 52, gold = 920,  grain = 2800 },
  { id = "jianye",   name = "건업", q = 3, r = 3, pop = 72, commerce = 76, land = 72, loyal = 60, flood = 58, gold = 1150, grain = 3300 },
  { id = "guangling",name = "광릉", q = 4, r = 3, pop = 34, commerce = 46, land = 50, loyal = 50, flood = 50, gold = 500,  grain = 1600 },
  -- r4 익주·형중·강동남
  { id = "chengdu",  name = "성도", q = -2, r = 4, pop = 100, commerce = 80, land = 84, loyal = 62, flood = 62, gold = 1400, grain = 3900 },
  { id = "jiangling",name = "강릉", q = -1, r = 4, pop = 58, commerce = 64, land = 70, loyal = 56, flood = 58, gold = 880,  grain = 2700 },
  { id = "chaisang", name = "시상", q = 0, r = 4, pop = 38, commerce = 54, land = 56, loyal = 55, flood = 54, gold = 620,  grain = 1900 },
  { id = "wujun",    name = "오군", q = 1, r = 4, pop = 66, commerce = 72, land = 68, loyal = 58, flood = 56, gold = 950,  grain = 2800 },
  { id = "kuaiji",   name = "회계", q = 2, r = 4, pop = 54, commerce = 60, land = 60, loyal = 56, flood = 54, gold = 720,  grain = 2200 },
  -- r5 형남·익동
  { id = "jiangzhou",name = "강주", q = -2, r = 5, pop = 26, commerce = 40, land = 50, loyal = 52, flood = 50, gold = 430,  grain = 1500 },
  { id = "wuling",   name = "무릉", q = -1, r = 5, pop = 20, commerce = 36, land = 48, loyal = 50, flood = 48, gold = 380,  grain = 1300 },
  { id = "changsha", name = "장사", q = 0, r = 5, pop = 48, commerce = 54, land = 60, loyal = 54, flood = 54, gold = 640,  grain = 2000 },
  -- r6 최남
  { id = "yunnan",   name = "운남", q = -2, r = 6, pop = 10, commerce = 26, land = 38, loyal = 46, flood = 40, gold = 280,  grain = 950 },
}
